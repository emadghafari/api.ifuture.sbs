...
<body>
    ...
    <div class="party-card">
        ...
        <div class="party-details">
            ...
            Phone: <strong dir="ltr">{{ $INVESTOR_PHONE ?? 'N/A' }}</strong><br>
    ...
    <div class="clause">
        ...
        Profit distribution shall be calculated strictly according to the Investor's ownership percentage. The Investor is entitled to <strong>{{ $SHARES_PERCENTAGE }}%</strong> of the total distributable annual profits generated by the project.<br><br>
    ...
    <div class="section-header">6. Protection, Risk, and Confidentiality</div>
        <div class="clause">
            ...
            <div class="list-item"><strong>Investor Equity Protection:</strong> The Investor's {{ $SHARES_PERCENTAGE }}% ownership share will be legally respected, documented, and indefinitely recorded in the Company's internal corporate equity registry.</div>
            <div class="list-item"><strong>Risk Acknowledgment:</strong> The Investor formally understands that investments in digital technology and early-stage software projects involve inherent financial risk. The Company formally commits to operating with the highest degree of professionalism to maximize growth and mitigate risks, but does not guarantee specific fiscal returns.</div>
            <div class="list-item"><strong>Strict Confidentiality:</strong> The Investor unconditionally agrees not to disclose, duplicate, or share any confidential business strategies, technical proprietary information, or financial data related to the Company or the project with any third parties.</div>
        </div>
