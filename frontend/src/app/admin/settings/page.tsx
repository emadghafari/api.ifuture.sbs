...
export default function AdminSettings() {
    ...
    return (
        <div className="max-w-5xl pb-20 font-sans text-slate-300">
            ...
            {/* Global Branding */}
            <div className="bg-[#091512]/95 backdrop-blur rounded-[2.5rem] shadow-sm border border-white/10 p-10 mb-8 flex items-center gap-10 text-slate-300">
                <div>
            ...
            {/* Payment Gateways */}
            <div className="bg-[#091512]/95 backdrop-blur rounded-[2.5rem] shadow-sm border border-white/10 p-10 mb-8">
                <h3 className="text-lg font-bold text-white mb-2">Crowdfunding Gateways (Global)</h3>
                <p className="text-sm text-slate-400 mb-6 flex items-center">
                    <svg className="w-4 h-4 mr-2 text-primary-500" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd"></path></svg>
                ...
                <div className="grid grid-cols-2 gap-10">
                    <div className="space-y-4">
                        <div className="flex items-center gap-2 mb-2">
                            <span className="bg-indigo-500/20 text-indigo-400 text-xs font-bold px-2 py-0.5 rounded border border-indigo-500/30">STRIPE</span>
                            <span className="text-sm font-semibold text-slate-300">Visa / Mastercard API</span>
                        </div>
                        <div>
                            <label className="block text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2">Secret Key (sk_...)</label>
                            <input type="password" placeholder="sk_live_..." value={getS('payment_stripe_secret', null)} onChange={(e) => updateValue('payment_stripe_secret', null, e.target.value)} className="w-full px-5 py-3 rounded-xl bg-[#040D0A] border border-white/10 focus:border-primary-500 text-white outline-none transition-colors font-mono text-sm" />
                        </div>
                    </div>
                    <div className="space-y-4">
                        <div className="flex items-center gap-2 mb-2">
                            <span className="bg-blue-500/20 text-blue-400 text-xs font-bold px-2 py-0.5 rounded border border-blue-500/30">PAYPAL</span>
                            <span className="text-sm font-semibold text-slate-300">PayPal REST API</span>
                        </div>
                        <div>
                            <label className="block text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2">Client ID</label>
                            <input type="password" value={getS('payment_paypal_client_id', null)} onChange={(e) => updateValue('payment_paypal_client_id', null, e.target.value)} className="w-full px-5 py-3 rounded-xl bg-[#040D0A] border border-white/10 focus:border-primary-500 text-white outline-none transition-colors font-mono text-sm" />
                        </div>
                        <div>
                            <label className="block text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2">Secret Token</label>
                            <input type="password" value={getS('payment_paypal_secret', null)} onChange={(e) => updateValue('payment_paypal_secret', null, e.target.value)} className="w-full px-5 py-3 rounded-xl bg-[#040D0A] border border-white/10 focus:border-primary-500 text-white outline-none transition-colors font-mono text-sm" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            {/* Global SEO Assets */}
            <div className="bg-[#091512]/95 backdrop-blur rounded-[2.5rem] shadow-sm border border-white/10 p-10 mb-8 flex items-start gap-16">
                <div>
            ...
            {/* Localized Content */}
            <div className="bg-[#091512]/95 backdrop-blur rounded-[2.5rem] shadow-sm border border-white/10 overflow-hidden">
